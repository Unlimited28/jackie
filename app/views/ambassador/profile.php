            ...
            <div class="dash-card-content">
                <form class="dash-form">
                    <div style="display: flex; align-items: center; gap: 24px; margin-bottom: 24px;">
                        <img src="<?= asset('assets/images/team-1.jpg') ?>" alt="User Avatar" style="width: 80px; height: 80px; border-radius: 50%;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" class="form-control" value="Amb. John Doe">
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="rank" class="form-control" value="Envoy" readonly>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="church" class="form-control" value="First Baptist Church">
                    </div>
                    <hr style="border-color: rgba(255,255,255,.1); margin: 24px 0;">
